setwd("F:/Northwestern - M.S. Predictive Analytics/Past Courses/Spring 2017_Course 410_Regression & Multivariate Analysis/Assignments/stock_portfolio/R stock_portfolio")
